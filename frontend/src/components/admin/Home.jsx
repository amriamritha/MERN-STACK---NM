    ...
    <>
      ...
      <div className='home-container'>
        ...
        <div className="right-side">
          <p>
            <span className='f-letter'>Easily schedule your doctor </span><br />
            <span className='s-letter'>appointments in just a few clicks.</span> <br />
            <span className='t-letter'>giving you full control over your health.</span><br />
            #2E8B57 color='book-doctor-btn' className='mt-3 register'><Link to={'/Login'}>Book your Doctor</Link></Button>
          </p>
        </div>
      </div>
      ...
      <Container>
        ...
        <div className="right-side">
          <p>
            Booking a doctor appointment has never been easier. With our convenient online platform, you can quickly and lessly schedule your appointments from the comfort of your own home. No more waiting on hold or playing phone tag with busy receptionists.
